    ...
    <div class="container mobile-container">
        ...
        <div class="flex-gorizontal">
            ...
            <div class="timer lotery-page-timer">
                ...
                <h3 class="timer__time timer__time_bottom" data ''><span class="hours timer__digit"></span> : <span class="minutes timer__digit"></span> : <span class="seconds timer__digit"></span> </h3>
        ...
        <div class="participate participate_top over-all">
            <p class="participate__text scrolling"><?= $model['description']->text ?></p>
        </div>
    </div>
    <div class="clouds">
