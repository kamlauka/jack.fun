...
<section class="lotery-page page-container">
    <?php if($model){?>
    <div class="container mobile-container">
        <div class="crumbs">
          ...
          <?php $model->date_start ?>

        <div class="flex-gorizontal">
            <div class="participate participate_bottom participate_top">
                <div class="algorithm">
            ...
            <div class="timer lotery-page-timer">
                <h3 class="timer__days"><span class="days timer__big-day-digit"></span> DAY</h3>
                <h3 class="timer__time timer__time_bottom"><span class="hours timer__digit"></span> : <span class="minutes timer__digit"></span> : <span class="seconds timer__digit"></span> </h3>
                ...
                <h3 class="timer__winning-money"> <?= $model->total ?> ETH</h3>
            </div>
    ...
    <div class="clouds clouds-bottom">
        <div class="cloud-container cloud-container_center-center-medium cloud-container_over-all">
            <div class="cloud">
                <div class="cloud cloud__cloud1"></div>
                <div class="cloud cloud__cloud2"></div>
                <div class="cloud cloud__cloud3"></div>
