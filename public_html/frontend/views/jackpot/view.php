    ...
    <div class="container container_mob mobile-container">
        ...
        <div class="flex-gorizontal">
            ...
            <div class="timer jackpot-page-timer">
                ...
                <h3 class="timer__time timer__time_bottom"><span class="hours timer__digit"></span><span class="colon">:</span>  <span class="minutes timer__digit"></span><span class="colon">:</span><span class="seconds timer__digit"></span></h3>
