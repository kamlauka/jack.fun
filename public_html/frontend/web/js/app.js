...
<<<<<<< HEAD
    tl = new TimelineMax({yoyo:false, repeat:-1, ease:Power1.easeInOut,});
    tl.to(cloud, 1, {rotation:-1},0).to(cloud, 1 , {rotation:1},1);

    // tl.fromTo(cloud, 1, {rotation:-1}, {rotation:1}, 0);
=======
