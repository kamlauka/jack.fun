...
class LangRequest extends \common\components\Request
{
    private $_lang_url;
    public $web;
    public $adminUrl;
    ...
    public function getLangUrl()
    {
        if ($this->_lang_url === null) {
            ...
            if ($lang_url !== null && $lang_url === Language::getCurrent()->alias &&
                strpos($this->_lang_url, Language::getCurrent()->alias) === 1) {
                $this->_lang_url = substr($this->_lang_url, strlen(Language::getCurrent()->alias) + 1);
            }
        }
